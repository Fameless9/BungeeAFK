...
The plugin is compatible with most other versions, but it is recommended to use the latest stable version of your server
software for optimal performance and compatibility.
